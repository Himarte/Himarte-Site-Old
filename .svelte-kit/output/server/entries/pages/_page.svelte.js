...
const imgRbs = "/_app/immutable/assets/logo-rbs.0ZO4NCkw.webp";
const imgUnimed = "/_app/immutable/assets/logo-unimed.3x3OrIjc.webp";
const imgSaoJoao = "/_app/immutable/assets/logo-sao-joao.npM2trVo.webp";
const imgMagalu = "/_app/immutable/assets/logo-magalu.0U6EzuY-.webp";
...
const css = {
  code: "@keyframes svelte-1xz60k2-vibate{0%{box-shadow:0 0px 2rem 0.1rem #eb4f27/50}25%{box-shadow:0 0px 2rem 0.1rem #eb4f27}50%{box-shadow:0 0px 2rem 0.1rem #eb4f27/80}75%{box-shadow:0 0px 2rem 0.1rem #eb4f27}100%{box-shadow:0 0px 2rem 0.1rem #eb4f27/50}}.vibrate.svelte-1xz60k2{animation:svelte-1xz60k2-vibate 3s ease-in-out infinite}.mainImgBg.svelte-1xz60k2{background-image:url('$lib/assets/img/extras/hi-astronauta-main.webp')}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let blipClient;
  $$result.css.add(css);
  return `<picture class="flex h-screen items-end justify-center bg-cover bg-center bg-no-repeat pb-40 mainImgBg svelte-1xz60k2"><p class="fontSpace text-center text-2xl font-bold md:text-6xl">${escape(fraseDigitada)}</p></picture> <img${add_attribute("src", Wave1t, 0)} alt="Wave1" class="flex w-full opacity-30"> <section class="flex flex-col items-center justify-center gap-10 p-10 md:pt-20"><div class="flex flex-col gap-10 md:flex-row"> <div class="relative"><figure class="absolute -left-[5.5rem] -top-[3.5rem] hidden w-52 -rotate-[20deg] sm:flex vibate" data-svelte-h="svelte-12opfgu"><img${add_attribute("src", seta, 0)} alt="Seta indicando o melhor preço" class="w-16 -rotate-6"> <figcaption class="absolute right-[1.3rem] bg-primary-800/40 -top-[0.9rem] rounded-xl border-2 px-2 text-xl font-bold text-white shadow-[0_0px_2rem_0.1rem] shadow-primary-700 hover:border-2 hover:border-white vibrate svelte-1xz60k2">Melhor Preço</figcaption></figure> ${validate_component(PlanetaCard, "PlanetaCard").$$render(
    $$result,
    {
      blipClient,
    ...
    {}
			...
			confiável, mas convidamos você a &quot;Dizer Hi para o futuro&quot;.</p> <p class="text-md p-5 text-justify md:text-2xl">Na Himarte, <span class="uppercase underline decoration-primary-600">o futuro é aqui</span>!</p></article> </section>`;
});
export {
  Page as default
};
