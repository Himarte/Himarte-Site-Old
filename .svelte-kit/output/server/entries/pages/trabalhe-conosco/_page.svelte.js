...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  )} <div class="flex w-full flex-col md:flex-row gap-5 md:justify-center"><button class="btn variant-ghost-primary font-semibold uppercase hover:variant-filled-primary w-[95%] md:w-1/5 self-center" data-svelte-h="svelte-jkxxyi">Limpar campos</button> <button class="btn variant-ghost-primary font-semibold uppercase hover:variant-filled-primary w-[95%] md:w-1/5 self-center" data-svelte-h="svelte-kafg3y">Enviar Currículo</button></div></form>   `;
});
export {
  Page as default
};
