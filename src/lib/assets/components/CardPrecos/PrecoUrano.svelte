<script>
	...
	import planetaUrano from '$lib/assets/img/panetas/urano.svg';
</script>
...
>
	...
	/>
	<div>
		<h5 class=" text-4xl font-bold text-primary-600">Urano</h5>
		<div class="flex flex-col items-baseline text-white">
			<span class="text-5xl font-extrabold tracking-tight"
				>120 <span class="text-3xl font-extrabold tracking-tight">MEGAS</span>
			</span>
