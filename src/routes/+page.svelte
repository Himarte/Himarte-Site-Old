...
<section class="flex flex-col gap-10 py-16">
	<h3 class="fontSpace flex items-center justify-center text-center text-2xl lg:text-4xl">
		Nossos clientes
	</h3>
	<div class="flex flex-wrap items-center justify-center gap-4">
		...
		<img
			src={imgRbs}
			alt="Logo RBS"
			class="  card card-hover flex w-40 items-center justify-center rounded-3xl p-3"
		/>
		<img
			src={imgUnimed}
			alt="Logo unimed"
